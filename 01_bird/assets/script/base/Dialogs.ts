...
export class Dialogs extends BaseComponent {
    ...
    __preload() {
        cc.log("    Dialogs __preload ",yyp.utils==null)
        super.__preload();
        
        this._bottomLayout_ = yyp.utils.createLayout(yyp.gameFrameSize.width*2,yyp.gameFrameSize.height*2,new cc.Color(0,0,0,255),this.node);
        this._bottomLayout_.addComponent(cc.BlockInputEvents);
        this._bottomLayout_.zIndex = -1;
        this._bottomLayout_.opacity = 0;
        
        this._topLayout_ = yyp.utils.createLayout(yyp.gameFrameSize.width*2,yyp.gameFrameSize.height*2,new cc.Color(0,0,0,255),this.node);
